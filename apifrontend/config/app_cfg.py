# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in ApiFrontend.
...
base_config.update_blueprint({
    'use_sqlalchemy': True,
    'model': apifrontend.model,
    'DBSession': apifrontend.model.DBSession,
})
...
base_config.update_blueprint({
    ...
    'sa_auth.cookie_secret': "3b5eb339-70a7-4d8a-bd13-6e6a7f45e4db",
